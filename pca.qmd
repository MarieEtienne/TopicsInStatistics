...
$$X^\intercal  X = P D P^\intercal.$$
* $I= tr(X^\intercal X) = tr(P D P^\intercal) = tr(P^\intercal P D ) = tr( D ) = \sum_{k=1}^d \sigma^2_k,$  
...
let $I_{\Delta_{U^\intercal}}$ the inertia of the set of data point projected on the line containing $G$ with direction $U$ ($U$ being an unitary vector) 

$x_i \dot U = x_i^\intercal \dot U$
